                    ...
                    <form action="{{ route('resep.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="catatan" rows="3"
                                class="mt-1 block w-full rounded-lg border-slate-300 text-sm focus:border-primary-500 focus:ring-primary-500">{{ old('catatan') }}</textarea>
                            @error('catatan')
            ...
            @else
                <div class="bg-white rounded-2xl border border-slate-100 p-6 text-sm text-slate-600">
                    <p class="font-semibold text-slate-800">
                        Anda tidak memiliki izin untuk membuat resep.
                    </p>
                    <p class="mt-2">
                        Silakan hubungi administrator atau gunakan menu lain yang tersedia.
                    </p>
                    <div class="mt-4">
                        <a href="{{ route('resep.index') }}"
                            class="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
